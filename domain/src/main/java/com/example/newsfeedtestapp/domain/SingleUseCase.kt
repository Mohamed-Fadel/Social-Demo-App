...
import com.example.newsfeedtestapp.domain.executor.PostExecutionThread
import com.example.newsfeedtestapp.domain.executor.ThreadExecutor
...
abstract class SingleUseCase<Params, Result> constructor(
    ...
    open fun execute(singleObserver: DisposableSingleObserver<Result>) {
        val single = this.buildUseCaseObservable(requestValues)
